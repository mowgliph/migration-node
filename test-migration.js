 ...
 * Uso: node test-migration.js [ruta-al-archivo]
 * Ejemplo: node test-migration.js src/components/modules/users/UsersTable.vue
 */
...
if (args.length === 0) {
  ...
  console.log('Uso: node test-migration.js [ruta-al-archivo]');
  process.exit(1);
}
